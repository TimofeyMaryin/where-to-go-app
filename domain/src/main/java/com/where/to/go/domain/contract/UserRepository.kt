...
interface UserRepository {
    ...
    suspend fun findUser(email: ResponseDomain): Response<UserDomain?>
    suspend fun uploadAvatar(userId: Int, file: MultipartBody.Part, authToken: String): Response<ResponseDomain>
